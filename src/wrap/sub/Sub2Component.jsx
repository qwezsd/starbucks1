    ...
    return (
        <main id='sub2' className='sub'>
            <div className="container">
                <div className="title">
                    <h2><img src="./img/starbucks/sub2/menu_tit.jpg" alt="" /></h2>
                ...
                <div className="content">
                    <ul>
                        <li>
                            <div className="gap">
                                ...
                                <div className="page-count">
                                    <a href="!#"><img src={`./img/starbucks/section2/main_prom_on.png`} alt="" /></a>
                                </div>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content2">
                                    ...
                                    <div onClick={onClickPoint} className={`relatable-product${state.ispoint ? ' on' : ''}`}>
                                    </div>
                        ...
                        <li>
                            <div className="gap">
                                <div className={`sub-content2-1${state.ispoint ? ' on' : ' off'}`}>
                                    <Sub2ChildComponent 제품={state.제품} />
                                </div>
                            </div>
                        </li>
                        <li>
                            <div className="gap">
                                <div className="sub-content3">
                                    ...
                                    <img src="./img/starbucks/sub2/menu_btxt_221109.png" alt="" />
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content4">
                                    ...
                                    <img src="./img/starbucks/sub2/menu_btxt2.png" alt="" />
                                    <button>자세히 보기</button>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content5">
                                    ...
                                    <img src="./img/starbucks/sub2/menu_btxt3.png" alt="" />
                                    <button>자세히 보기</button>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content6">
                                    ...
                                    <img src="./img/starbucks/sub2/menu_btxt4.png" alt="" />
                                    <button>자세히 보기</button>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content7">
                                    ...
                                    <img src="./img/starbucks/sub2/teavana_txt_221109.png" alt="" />
                                    <button>자세히 보기</button>

    ...
    return (
        <main id='sub4' className='sub'>
            <div className="container">
                <div className="title">
                    <h2><img src="./img/starbucks/sub4/responsibility_tit.jpg" alt="" /></h2>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content3">
                                    ...
                                    <img src="./img/starbucks/sub4/responsibility05_txt.png" alt="" />
                                    <button>매장 찾기</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content4">
                                    ...
                                    <img src="./img/starbucks/sub4/responsibility01_txt.png" alt="" />
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content5">
                                    ...
                                    <img src="./img/starbucks/sub4/responsibility02_txt.png" alt="" />
                                    <button>자세히 보기</button>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content6">
                                    ...
                                    <img src="./img/starbucks/sub4/responsibility03_txt.png" alt="" />
                                    <button>자세히 보기</button>
                        ...
                        <li>
                            <div className="gap">
                                <div className="sub-content7">
                                    ...
                                    <img src="./img/starbucks/sub4/responsibility04_txt.png" alt="" />
                                    <button>자세히 보기</button>
